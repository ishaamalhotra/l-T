...
with tabs[5]:
    ...
    with col_r:
        ...
        fig9.add_trace(go.Scatter(x=rt["Cycle"], y=rt["Condition_Pct"],
                                  ...
                                  line=dict(color=GREEN), fillcolor="rgba(74,222,128,0.18)"))
...
with tabs[6]:
    ...
    with col_l:
        ...
        fig10.add_trace(go.Scatter(x=energy_cycles, y=single_use_energy,
                                   ...
                                   line=dict(color=RED), fillcolor="rgba(248,113,113,0.12)"))
